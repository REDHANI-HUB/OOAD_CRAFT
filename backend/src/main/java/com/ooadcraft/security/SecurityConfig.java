package com.ooadcraft.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/patterns", "/api/patterns/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/case-studies", "/api/case-studies/**").permitAll()
